	...
	events = [
		{
			...
			description: 'Join us on Saturday, August 5th at the National Museum of Mexican Art for a program that explores the unique history of “Duranguense” music in Chicago. The program will include a short video and bilingual discussion with Jose Luis Terrazas of Montéz de Durango and Chicago Latin music promoter Ivan Fernandez hosted by Mateo Mulcahy of the Old Town School of Folk Music. The program will culminate in a performance by Chicago musical group Show Revelación. The style of Chicago Mexican music know as Duranguense music exploded in the 90’s through the seed planted by Montéz de Durango. This style of music caught on in Chicago and spawned dozens of wildly popular bands throughout Mexican communities throughout the U.S. and all over Mexico. This Chicago phenomena exported a Chicago born, Mexican-American genre back to Mexico and became the hottest new style of Mexican music and dance. The Chicago origins of this style of Mexican music are not widely known or understood and this event at the National Museum of Mexican Art aims to educate the Chicago audience and celebrate this extraordinary musical style. This event is a precursor to a free concert in Harrison Park on August 13th from 2-6pm headlined by Chicago Duranguense icons Montez de Durango and also featuring Show Revelación and Norteñisimo Zierra Azul.',
