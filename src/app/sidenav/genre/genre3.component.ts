  ...
  events = [
    {
      ...
      tabs: [
        {  
          ...
          content: `
            <p>
              20 years after Reginald Robinson’s emergence as a young, self-taught, against the grain pianist and composer, he has become an internationally recognized musician, recording artist and educator.
            </p>
            <p>
    ...
    tabs: [
      {  
        ...
        content: `
          ...
          <p>
            By then, the music had shifted. Jazz had originally resembled a wild tapestry of different threads, with each instrument playing a separate line; by the 30s, the sound was morphing into a luxurious machine-tooled fabric, as the bands grew bigger and sleeker. New York had Duke Ellington and Kansas City had Count Basie. Chicago had Benny Goodman, a young clarinetist who assembled an orchestra in 1935 that launched the Swing Era and created the jazz style that became America’s popular music in the years leading out of the Great Depression and into World War II. You won’t find too many swing orchestras of that ilk these days. But you can find artists who, on occasion, channel the small groups that co-existed with those orchestras – artists such as reedmen Eric Schneider and Chris Madsen, guitarists Andy Brown and Alfonso Ponticelli, vocalists Rose Colella and Kimberly Gordon – at clubs such as Andy’s (11 E. Hubbard); Winter’s (465 N. McClurg); and S.I.P. (4000 N. Southport). 
          </p>
          <p>
