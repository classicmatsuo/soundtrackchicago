...
module.exports = "<md-card class=\"placeholder\">\n\t<img alt=\"Soundtrack of the City\" src=\"../../../assets/SOTC_HomepagePlaceholder_051717.png\" />\n\t<md-card-content>\n\t\t<h3>MAY 15 - AUGUST 1, 2017</h3>\n\t</md-card-content>\n</md-card>\n<div class=\"genre-list\">\n  <md-card *ngFor=\"let genre of genres; index as i;\" class=\"genre {{genre.name}}\" routerLink=\"{{genre.link}}\" routerLinkActive=\"active\">\n  \t<img class=\"card-image\" src=\"{{genre.image}}\">\n    <h4>{{genre.name}}</h4>\n  \t<span>{{genre.description}}</span>\n  </md-card>\n</div>\n"
...
module.exports = "<div class=\"card-container\">\n  <md-card *ngFor=\"let event of events; index as i;\" class=\"{{event.genre}}\">\n    <md-card-header>\n      <div md-card-avatar class=\"event{{i +1}}image\"></div>\n      <md-card-title>\n        <h3>{{event.date}} {{event.time}}</h3>\n        {{event.location}}\n        <h2>{{event.title}}</h2>\n      </md-card-title>\n      <md-card-subtitle>\n        {{event.lead}}<br>\n        <em>{{event.admission}}</em>\n      </md-card-subtitle>\n    </md-card-header>\n    <img class=\"card-image\" src=\"{{event.image}}\">\n    <md-card-content>\n      <p>\n        {{event.description}}\n      </p>\n      <p *ngIf=\"event.link\">\n        <a href=\"{{event.link}}\" target=\"_blank\">{{event.link}}</a>\n      </p>\n      <md-tab-group dynamicHeight *ngIf=\"event.tabs\">\n        <md-tab *ngFor=\"let tab of event.tabs\">\n          <ng-template md-tab-label class=\"tab-label\">\n            {{tab.tabname}}\n          </ng-template>\n          <h4>{{tab.title}}</h4>\n          <img *ngIf=\"tab.image\" class=\"card-image\" src=\"{{tab.image}}\">\n          <div [innerHTML]=\"tab.content\">\n            \n          </div>\n        </md-tab>\n      </md-tab-group>\n    </md-card-content>\n  </md-card>\n</div>\n\n\n\n\n\n\n\n\n\n"
